...
\labelsec{intro}
%===========================================================================
The following report describes the software development process employed to analyze, design and implement an IoT application. The whole process is divided into two steps: at first, the client will communicate the initial requirements for the application, then new features will be requested. This report will show the impact of client requirements changes on the project on both the design and implementation phase.
%===========================================================================
\section{Vision}
\labelsec{Vision}
%===========================================================================
