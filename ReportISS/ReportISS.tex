...
\begin{itemize}
\item the commands are sent to the robot
...
\end{itemize}
At this stage in the development process, we can't define more specific functional or integration test. However, we could test the parts of the system defined with our custom language creating mock entities that 
