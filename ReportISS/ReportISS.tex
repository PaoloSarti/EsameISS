...
A new robot is introduced, similar to the previous one. It needs a way to remove the bomb. We just need to add the following to the previous domain model:
...
We need to check if the second robot receives can reach the bomb and remove it. We can test this observing the whole system when the ASC emits the alarm.
