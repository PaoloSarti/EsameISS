...
actorOp( Op )   :- % actorPrintln( actorOp( Op  ) ),
				   java_catch(
						qatuled <- Op returns R, 	%% R unbound if void
...
%% setActionResult : qatuled register (in Java) the result under name 'actoropresult'
