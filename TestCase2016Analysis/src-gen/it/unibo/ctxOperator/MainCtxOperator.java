...
public class MainCtxOperator extends ActorContext implements IActivity{
private IBasicEnvAwt env; 
private it.unibo.qactor.robot.RobotActor robot; 
 
	public MainCtxOperator(String name, IOutputEnvView outEnvView,
...
*/
	public static void main(String[] args) throws Exception{
		IOutputEnvView outEnvView = SituatedSysKb.standardOutEnvView;
 		InputStream sysKbStream    = //MainCtxOperator.class.getResourceAsStream("testcase2016analysis.pl");
 			new java.io.FileInputStream("./srcMore/it/unibo/ctxOperator/testcase2016analysis.pl");
		InputStream sysRulesStream = MainCtxOperator.class.getResourceAsStream("sysRules.pl");
		new MainCtxOperator("ctxOperator", outEnvView, sysKbStream, sysRulesStream ).configure();
 	}
}
