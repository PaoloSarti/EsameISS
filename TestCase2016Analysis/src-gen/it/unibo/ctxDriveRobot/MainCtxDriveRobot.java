...
package it.unibo.ctxDriveRobot;
...
public class MainCtxDriveRobot extends ActorContext implements IActivity{
private IBasicEnvAwt env; 
private it.unibo.qactor.robot.RobotActor robot; 
 
	public MainCtxDriveRobot(String name, IOutputEnvView outEnvView,
...
*/
	public static void main(String[] args) throws Exception{
		IOutputEnvView outEnvView = SituatedSysKb.standardOutEnvView;
 		InputStream sysKbStream    = //MainCtxDriveRobot.class.getResourceAsStream("testcase2016analysis.pl");
 			new java.io.FileInputStream("./srcMore/it/unibo/ctxDriveRobot/testcase2016analysis.pl");
		InputStream sysRulesStream = MainCtxDriveRobot.class.getResourceAsStream("sysRules.pl");
		new MainCtxDriveRobot("ctxDriveRobot", outEnvView, sysKbStream, sysRulesStream ).configure();
 	}
}
